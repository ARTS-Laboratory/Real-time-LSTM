...
"""
This is v7-1 because I started v7 but it looks like it got lost before being pushed to GitHub (my computer died)
Now we are working towards putting this on an FPGA, and there are two things
I want to do first.
    1. Check how much worse the model performs with the piecewise activation
    functions.
    2. Try my hand at a (model) dimensionality reduction using SVD. This is for
    my final project in another class. I think it will probably have either no
    or a very small effect in shrinking the model.
