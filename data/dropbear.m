...
history_lengths1 = [20:5:50];
history_lengths2 = [5:5:30];
...
for history1 = history_lengths1
    for history2 = history_lengths2
...
%         pause(0.01);
        ...
        numFeatures = 1;
        numResponses = 1;
        numHiddenUnits1 = history1;
        numHiddenUnits2 = history2;
...
%         s.(name) = MiniBatchSize;
        ...
        display(numHiddenUnits1);
        display(numHiddenUnits2);
...
%         signal_power = rms(signal_snip)^2;
        ...
        name = sprintf("SNR4_Units%d_%d", numHiddenUnits1, numHiddenUnits2);
        s.(name) = subsample_snr;
        
        name = sprintf("RMSE4_Units%d_%d", numHiddenUnits1, numHiddenUnits2);
        s.(name) = rmse;
